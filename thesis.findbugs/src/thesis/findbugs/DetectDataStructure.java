...
public class DetectDataStructure implements Detector {
    ...
    private class UselessValuesContext {
        ...
        void initObservedValues() throws DataflowAnalysisException {
            ...
            // Mark each object declaration in the source code
            for (ValueInfo vi : observedValues.values()) {
            	BugInstance bug = new BugInstance("DETECT_DS_INIT", NORMAL_PRIORITY).
        ...
        Iterator<GenLocation> genIterator() {
            return new Iterator<DetectDataStructure.GenLocation>() {
    ...
    public DetectDataStructure(BugReporter reporter) {
